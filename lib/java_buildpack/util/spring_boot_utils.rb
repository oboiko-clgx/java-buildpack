...
module JavaBuildpack
  module Util
    ...
    class SpringBootUtils
      ...
      def cache_thin_dependencies(java_command, application_root, thin_root)
        shell "#{java_command} -Dthin.root=#{thin_root} -Dthin.dryrun -cp #{application_root} #{THIN_WRAPPER}"
      end
